...
> Lab: [partner.skills.google …/labs/629113](https://partner.skills.google/paths/85/course_templates/627/labs/629113)  
> Same as public GSP229 (verified against partner-lab paste).
...
Click the + (SQL query) button, then copy and paste the following query into the BigQuery Editor:
...
Explore the raw table (your note):
...
Training metrics (`classification_model`):

![classification_model training metrics](img/classification_model_training_metrics.png)
...
After your model is trained, you will see the message "Successfully created model named classification_model.".
...
Evaluation (`classification_model`):

![classification_model evaluation](img/classification_model_evaluation.png)
...
Thinking / feature query (your note, commented):
...
Training metrics (`classification_model_2`):

![classification_model_2 training metrics](img/classification_model_2_training_metrics.png)
...
Evaluation (`classification_model_2`):

![classification_model_2 evaluation](img/classification_model_2_evaluation.png)
...
To open the `bigquery-public-data` dataset, click + Add data. Click Star a project by name under Additional sources. Then write the `bigquery-public-data` name. Click Star. The `bigquery-public-data` project is listed in the Explorer section.
